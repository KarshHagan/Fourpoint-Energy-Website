<?php 
	$pageTitle = 'FourPoint Energy - Business Opportunities';
	$pageDescription = '';
	$fbShareImg = '';
	$thisPage = "";
...
<section class="affiliation_logos">
	<div class="logo"><img src="/assets/img/affiliation_logos/AAPG_Logo.png" alt="SPE Logo"></div>
	<div class="logo"><img src="/assets/img/affiliation_logos/AAPL_Logo.png" alt="SPE Logo"></div>
